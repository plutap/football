...
use Gajdaw\FootballBundle\Entity\Game;
use Gajdaw\FootballBundle\Form\GameType;
...
class GameController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GajdawFootballBundle:Game')->findAll();
     ...
     * @Method("POST")
     * @Template("GajdawFootballBundle:Game:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GajdawFootballBundle:Game')->find($id);
     ...
     * @Method("PUT")
     * @Template("GajdawFootballBundle:Game:edit.html.twig")
     */
